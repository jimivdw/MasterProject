...
To evaluate the project, the developed tool will be subjected to a number of user studies. Currently, however, the presumed user base is limited to a small number of researchers. Furthermore, half of these researchers is located in Australia, which makes it infeasible to include them in user studies. Luckily, project supervisors Klau and El-Kebir keep a close connection with most other target researchers at VU University Amsterdam. They will presumably be willing to participate in the user studies and can hopefully help to find some other test subjects.
