...
\begin{frame}{x}{}
 \begin{center}
  \textit{How should chemists interact with a tool for fragment-based molecule parameterisation, such that using this tool yields results of comparable quality to using conventional methods, while taking less time to complete?}
 \end{center}
 \begin{enumerate}
  \item<2-> Is it feasible to do manual partial charge assignment in a reasonable amount of time, i.e.\ faster than performing computations?
  \item<3-> Compared to the computed charges, how accurate are the charges obtained using manual charge assignment?
  \item<4-> How should chemists interact with a system for finding atomic partial charges using fragments of other molecules?
 \end{enumerate}
\end{frame}
