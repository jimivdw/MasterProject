...
In this chapter, the problems we try to solve in this project are discussed. First, we provide a brief explanation of the chemical concepts used in the project~(\secref{chemical}), followed by the interaction design challenges in \secref{id_challenges}.
