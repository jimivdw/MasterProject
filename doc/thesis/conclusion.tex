...
It can therefore be concluded that both of the hypotheses posed in \secref{ra_hypotheses} hold. The consuming interaction design presented here turned out to be the best one, and, using \oframp, it should definitely be possible to create molecule parameterisation of equal quality to the calculated ones, in less time.
