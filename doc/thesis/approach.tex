...
\item Limit to 'parameterise 2 molecules';
\item Limit next paragraph to 'build in a log system'.
\end{todo}
...
\begin{todo}
\item Limit to 'there will be a questionnaire after each version and one at the end'.
\end{todo}
