...
In order to evaluate the two implementations, both of them will be subjected to a user study~(see \secref{ra_studies}). This will help to determine if the system works properly and whether it is fit for its tasks. We will be able to answer the project's research questions, and test the hypotheses that will be discussed in \secref{ra_hypotheses}.
